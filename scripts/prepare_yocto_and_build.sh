...
cp -Tr $ROOT_PROJECT_PATH/yocto_files/recipes-devtools ../$LAYER_NAME/recipes-devtools
...
mkdir -p $BINS
cp ./tmp/work/x86_64-linux/qemu-helper-native/1.0-r1/recipe-sysroot-native/usr/bin/qemu-system-x86_64 $BINS/qemu-system-x86_64
cp ./tmp/deploy/images/qemux86-64/bzImage $BINS/bzImage
cp ./tmp/deploy/images/qemux86-64/core-image-full-cmdline-qemux86-64.ext4 $BINS/first-image.ext4
cp ./tmp/deploy/images/qemux86-64/core-image-full-cmdline-qemux86-64.ext4 $BINS/second-image.ext4
